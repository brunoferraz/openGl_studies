...
#include "../InterfaceV4/Lib3d/Display/UiElements/grid.h"
...
const QMetaObject Grid::staticMetaObject = {
    { &BasicUiObj::staticMetaObject, qt_meta_stringdata_Grid.data,
...
void *Grid::qt_metacast(const char *_clname)
{
    ...
    return BasicUiObj::qt_metacast(_clname);
}

int Grid::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = BasicUiObj::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
